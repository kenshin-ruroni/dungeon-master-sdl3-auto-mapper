    ...
    if (D4W < 136)
    {
      ...
      if (D4W >= 0)
      {
        ...
        if (rect_42.b.x2 > rect_42.b.x1)
        {
          ...
          if ( (LOCAL_36!=0) || (w_142) )
          {
            memmove( (ui8 *)tempBitmap,(ui8 *)A3, LOCAL_22*LOCAL_24);
            A3 = (i8 *)tempBitmap;
          };
          if (LOCAL_36 != 0)
          {
...
*/
             ...
             || frontViewMirror_106 && !mtDescWord4_76.NonAttackingMirrorOK() )
        {
          if ( !frontViewMirror_106 || (!derivedGraphicAlreadyExists) )
          {
            ...
            if (!frontViewMirror_106)
            {
              memmove( (ui8 *)tempBitmap,(ui8 *)A3, (ui16)D4W*(ui16)dstHeight);
              A3 = (i8 *)tempBitmap;
            };
...
//  ui8  *uA3;
  ...
  if (touchable)
  {
    ...
    if (pButtonDef->x1 == 255)
    {
      ...
      memmove( (ui8 *)pButtonDef,(ui8 *)&rect_42, 4);
  ...
  */
  ...
  tag0063be:
    ...
    if ( (LOCAL_36!=0) || (w_142!=0) )
    {
      ...
      if (A3 != (i8 *)tempBitmap)
      {
        memmove( (ui8 *)tempBitmap,(ui8 *)A3, D4W * LOCAL_24);
        A3 = (i8 *)tempBitmap;
      };
      if (w_142 != 0)
      {
...
//tag0065bc:
  ...
  {
    RelativeCellNumber -= 3;
    //memmove( b_170,d.Byte4010 + 8*RelativeCellNumber, 8);
    memmove( (ui8 *)&b_170,(ui8 *)&d.teleporterRectangles[RelativeCellNumber], 8);
    b_170.b.x1++;
