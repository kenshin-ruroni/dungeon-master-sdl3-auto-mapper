               ...
               )
{
  ...
  for (;;)
  {
    ...
    case StdDrawSeeThruDoorEdge:
               memmove( (ui8 *)tempBitmap,d.pDoorBitmaps[1], 1968);
...
void FloorAndCeilingOnly(void)
{
  ...
  memmove( d.pViewportBMP,d.pCeilingBitmap, 3248);//ceiling
  memmove( d.pViewportFloor,d.pFloorBitmap, 7840);//floor
  d.Word11684=0;
}
  ...
  case roomDOORFACING:
    /*
      ...
      DrawRoomObjects(
            ...
            pRoomData->relativeCellNumber,
            0x128);
      memmove( d.Pointer1848,d.pDoorBitmaps[5], 704);
...
void DrawCellF2(i32 /*facing*/, SUMMARIZEROOMDATA *pRoomData)
{
  ...
  case roomDOORFACING:
    /*
      ...
      memmove( d.Pointer1848,d.pDoorBitmaps[3], 1560);
...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  case roomDOOREDGE:
    /*
      if (d.SeeThruWalls != 0)
      {
        memmove( d.Pointer1848,d.pDoorBitmaps[1], 1968);
        if (!skipDrawing)
        TAG0088b2(GetBasicGraphicAddress(41),
                  d.Pointer1848,
                  (RectPos *)d.uByte2542,
