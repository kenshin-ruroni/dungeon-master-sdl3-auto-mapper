...
//
      ...
      D0W = (i16)(D0W - (D4W+1));
      memmove( (ui8 *)prnA3+2,(ui8 *)prnA3, 2*D0W);
      *prnA3 = newObj;
...
//Loop:
  for (;numCellsToTry>0; numCellsToTry--)
  {
    ...
    if (numCellsToTry > 1)
    {
      ...
      missileY = newY;
      //oldY |= (newY << 8);
      memmove( (ui8 *)&whoLeavesCell,(ui8 *)&whoLeavesNewCell, 4);
      //goto Loop;
    };
  };
  return 0;
...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  {
    memmove((ui8 *)&d.PartyFootprints[D7W],(ui8 *)&d.PartyFootprints[D7W+1],2*D6W);
    memmove((ui8 *)&d.Byte13220[D7W],(ui8 *)&d.Byte13220[D7W+1],D6W);
  };
